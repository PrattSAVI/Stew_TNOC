...
app.layout = html.Div( #Main Div Container
        ...
        [   html.Div(
                [
                    ...
                    html.P( 'Recusandae unde dolorem distinctio quo cumque sed voluptatem et. At facere sint qui molestiae consequatur. Excepturi nemo facilis qui. Voluptas sint corporis voluptatem. Veniam ad et qui.<br>Saepe odio quas ut sit dolorem illo ullam et. Odit harum ullam aut. Voluptatum qui odit veniam. Ea et sit tempore ipsum sint eum. Placeat doloremque soluta eligendi eum deleniti. Accusamus mollitia doloremque fuga in dolorem consequatur porro dolores.' )
                ],className='row', style = {
                                        'marginBottom': '0em',
                                        'marginLeft': '0em',
                                        'marginRight': '0em',
            ...
            className='row', style = { 'width':1400 } ),
